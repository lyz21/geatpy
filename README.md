...
![Pypi](https://img.shields.io/badge/pypi-2.4.0-blue.svg)
...
## Improvement of Geatpy 2.4.0

* Improved the performance of the cores: 'xovexp' and 'otos'.

* Better support for importing prior knowledge.

* Supported multi-population.

* Added two new cores: 'migrate' and 'mselecting' for multi-population evolution.
